...
<div class="demo-slot">
  <p>Espacio reservado para una demo de Shinylive</p>
  <code>app-00 · sin API key · integración posterior</code>
</div>
...
:::: {.columns}
::: {.column width="36%"}
<p class="pattern-label">Patrón 01</p>
...
:::: {.columns}
::: {.column width="36%"}
<p class="pattern-label">Patrón 02</p>
...
:::: {.columns}
::: {.column width="36%"}
<p class="pattern-label">Patrón 03</p>
...
:::: {.columns}
::: {.column width="36%"}
<p class="pattern-label">Patrón 04</p>
...
:::: {.columns}
::: {.column width="36%"}
<p class="pattern-label">Patrón 05</p>
...
:::: {.columns}
::: {.column width="36%"}
<p class="pattern-label">Patrón 06</p>
...
:::: {.columns}
::: {.column width="34%"}
<p class="pattern-label">Patrón 08</p>
