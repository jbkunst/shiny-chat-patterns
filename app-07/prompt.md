...
El dashboard permite comparar filtros tradicionales con consultas solicitadas por chat.

Tools disponibles:

- Usa `consultar_paises` para responder preguntas sobre los datos.
- Usa `actualizar_dashboard` cuando el usuario quiera filtrar, ordenar o reiniciar mediante el chat.
